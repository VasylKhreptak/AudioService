    ...
    public class AudioService : IAudioService
    {
        ...
        public AudioService(Preferences preferences)
        {
            ...
            Mute = new Property<int, bool>(canAccess, id => _activePool[id].Audio.Mute,
                (id, value) => _activePool[id].Audio.Mute = value);
            BypassEffects = new Property<int, bool>(canAccess, id => _activePool[id].Audio.BypassEffects,
                (id, value) => _activePool[id].Audio.BypassEffects = value);
            ...
            Loop = new Property<int, bool>(canAccess, id => _activePool[id].Audio.Loop,
                (id, value) => _activePool[id].Audio.Loop = value);
            Priority = new Property<int, int>(canAccess, id => _activePool[id].Audio.Priority,
                (id, value) => _activePool[id].Audio.Priority = value);
            Volume = new Property<int, float>(canAccess, id => _activePool[id].Audio.Volume,
                (id, value) => _activePool[id].Audio.Volume = value);
            Pitch = new Property<int, float>(canAccess, id => _activePool[id].Audio.Pitch,
                (id, value) => _activePool[id].Audio.Pitch = value);
            StereoPan = new Property<int, float>(canAccess, id => _activePool[id].Audio.StereoPan,
                (id, value) => _activePool[id].Audio.StereoPan = value);
            SpatialBlend = new Property<int, float>(canAccess, id => _activePool[id].Audio.SpatialBlend,
                (id, value) => _activePool[id].Audio.SpatialBlend = value);
            ReverbZoneMix = new Property<int, float>(canAccess, id => _activePool[id].Audio.ReverbZoneMix,
                (id, value) => _activePool[id].Audio.ReverbZoneMix = value);
            DopplerLevel = new Property<int, float>(canAccess, id => _activePool[id].Audio.DopplerLevel,
                (id, value) => _activePool[id].Audio.DopplerLevel = value);
            Spread = new Property<int, float>(canAccess, id => _activePool[id].Audio.Spread,
                (id, value) => _activePool[id].Audio.Spread = value);
            ...
            MinDistance = new Property<int, float>(canAccess, id => _activePool[id].Audio.MinDistance,
                (id, value) => _activePool[id].Audio.MinDistance = value);
            MaxDistance = new Property<int, float>(canAccess, id => _activePool[id].Audio.MaxDistance,
                (id, value) => _activePool[id].Audio.MaxDistance = value);
